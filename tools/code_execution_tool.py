...
def _execute_remote(
    ...
    try:
        ...
        # Start RPC polling thread. Preserve gateway/session contextvars so
        # tool calls made from execute_code (for example terminal approvals)
        # resolve against the same Telegram/Discord/etc. session as the
        # parent agent turn.
