---
name: postly-cold-email-outreach
description: Cold email outreach for Postly.mn — find companies with broken/non-existent websites, research their contact emails (prefer Facebook), and send professional Mongolian-language sales emails.
version: 1.0.0
author: Hermes Agent
tags: [postly, cold-email, sales, outreach, mongolia]
---

# Postly Cold Email Outreach

Find companies with broken/non-functional websites and send professional cold sales emails offering Postly.mn web development services.
...
### Step 2: Find Contact Email (IMPORTANT)
...
- **Body structure:**
  - Greeting
  - State finding (website not working / not existing)
  - Introduce Postly.mn
  - List key features (responsive, SSL/security, SEO-friendly, low cost, fast)
  - CTA: www.postly.mn
  - Closing: Postly.mn team / Battushig Tuguldur
...
Send via Gmail using the Hermes venv Python:
```bash
